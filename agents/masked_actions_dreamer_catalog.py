...
from ray.rllib.algorithms.dreamerv3.utils import get_gru_units, get_num_z_categoricals, get_num_z_classes, do_symlog_obs
from ray.rllib.core.models.base import Encoder, Model
from ray.rllib.core.models.catalog import Catalog
from ray.rllib.utils import override


class MaskedActionsDreamerCatalog(Catalog):
    ...
    def build_encoder(self, framework: str) -> Encoder:
        ...
        if framework == "torch":
            ...
            return mlp.MLP(
                input_size=int(np.prod(self.observation_space["observations"].shape)),
    ...
    def build_world_model(self, framework: str, *, encoder, decoder) -> Model:
        ...
        return WorldModel(
            model_size=self.model_size,
            observation_space=self.observation_space["observations"],
